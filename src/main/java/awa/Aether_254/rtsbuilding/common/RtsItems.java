package awa.Aether_254.rtsbuilding.common;

import awa.Aether_254.rtsbuilding.RtsbuildingMod;
import awa.Aether_254.rtsbuilding.server.plugin.RtsPluginItem;
...
public final class RtsItems {
    ...
    private static DeferredHolder<Item, Item> pluginItem(String id, boolean creative) {
        DeferredHolder<Item, Item> holder = ITEMS.register(
                id, () -> new RtsPluginItem(itemProperties(id).stacksTo(64)));
        if (creative) {
    ...
    public static DeferredHolder<Item, Item> simpleItem(String id, boolean creative) {
        DeferredHolder<Item, Item> holder = ITEMS.register(id, () -> new Item(itemProperties(id)));
        if (creative) {
            CREATIVE_TAB_ITEMS.add(holder);
        }
        return holder;
    ...
    public static DeferredHolder<Item, BlockItem> blockItem(String id,
        ...
        DeferredHolder<Item, BlockItem> holder =
                ITEMS.register(id, () -> new BlockItem(block.get(), itemProperties(id)));
        if (creative) {
            CREATIVE_TAB_ITEMS.add(holder);
        }
        return holder;
    ...
    public static DeferredHolder<Item, BlockItem> blockItem(String id,
        ...
        DeferredHolder<Item, BlockItem> holder =
                ITEMS.register(id, () -> new BlockItem(block.get(), withId(id, properties)));
        if (creative) {
            CREATIVE_TAB_ITEMS.add(holder);
        }
        return holder;
