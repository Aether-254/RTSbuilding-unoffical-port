...
public final class CreateBlueprintCompatibilityGameTests {
    ...
    public static void createVaultBlueprintRebuildsControllerAtPlacement(GameTestHelper helper) {
        Identifier vaultId = Identifier.fromNamespaceAndPath("create", "item_vault");
        Block vault = BuiltInRegistries.BLOCK.getValue(vaultId);
    ...
    public static void createBeltBlueprintDropsStaleRuntimeTopology(GameTestHelper helper) {
        Identifier beltId = Identifier.fromNamespaceAndPath("create", "belt");
        Block belt = BuiltInRegistries.BLOCK.getValue(beltId);
        ...
        helper.assertTrue("ANDESITE".equals(prepared.getStringOr("Casing", "")),
                "Prepared Create belt lost its casing");
        helper.assertTrue(prepared.getBooleanOr("Covered", false),
                "Prepared Create belt lost its cover");
        helper.assertTrue("RED".equals(prepared.getStringOr("Dye", "")),
    ...
    private static void assertNoStalePosition(
        ...
        int[] value = tag.getIntArray(key).orElseGet(() -> new int[0]);
