...
public final class RtsPageHandlers {
    ...
    public static void handleRequestStoragePage(awa.Aether_254.rtsbuilding.network.storage.C2SRtsRequestStoragePagePayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
