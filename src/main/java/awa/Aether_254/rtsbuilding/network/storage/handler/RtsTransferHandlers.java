...
public final class RtsTransferHandlers {
    ...
    public static void handleFillInventory(awa.Aether_254.rtsbuilding.network.storage.C2SRtsFillInventoryPayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void handleLinkedPickup(awa.Aether_254.rtsbuilding.network.storage.C2SRtsLinkedPickupPayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            if (context.player() instanceof ServerPlayer serverPlayer) {
    ...
    public static void handleLinkedQuickMove(awa.Aether_254.rtsbuilding.network.storage.C2SRtsLinkedQuickMovePayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            if (context.player() instanceof ServerPlayer serverPlayer) {
    ...
    public static void handleReturnCarried(awa.Aether_254.rtsbuilding.network.storage.C2SRtsReturnCarriedPayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            if (context.player() instanceof ServerPlayer serverPlayer) {
    ...
    public static void handleImportMenuSlot(awa.Aether_254.rtsbuilding.network.storage.C2SRtsImportMenuSlotPayload payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            if (context.player() instanceof ServerPlayer serverPlayer) {
