...
import awa.Aether_254.rtsbuilding.server.service.mining.RtsToolLeaseManager;
        ...
        switch (type) {
            ...
            case AREA_DESTROY: {
                ...
                if (enqueued && mctx.hasWorkflowEntryId()) {
                    int totalTargets = awa.Aether_254.rtsbuilding.server.task.RtsTaskEngine.INSTANCE
