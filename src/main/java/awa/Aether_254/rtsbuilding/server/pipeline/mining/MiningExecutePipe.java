...
import awa.Aether_254.rtsbuilding.server.pipeline.context.MiningContext;
import awa.Aether_254.rtsbuilding.server.pipeline.core.*;
...
import awa.Aether_254.rtsbuilding.server.pipeline.workflow.WorkflowCompletePipe;
...
import awa.Aether_254.rtsbuilding.server.service.mining.RtsToolLease;
...
public final class MiningExecutePipe implements PipelinePipe<MiningContext> {
    ...
    public PipelineResult execute(MiningContext ctx) {
        ...
        boolean submitted = awa.Aether_254.rtsbuilding.server.task.RtsTaskEngine.INSTANCE
