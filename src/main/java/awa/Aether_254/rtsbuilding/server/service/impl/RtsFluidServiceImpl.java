...
import awa.Aether_254.rtsbuilding.server.service.api.FluidService;
import awa.Aether_254.rtsbuilding.server.service.transfer.RtsFluidTransferGateImpl;
import awa.Aether_254.rtsbuilding.server.storage.FluidTransferGate;
 ...
 * <p>该实现类协调多个系统组件：
 * <ul>
 *   <li>使用 {@link awa.Aether_254.rtsbuilding.server.storage.RtsStorageFluids} 执行实际的流体存取逻辑</li>
 *   <li>使用 {@link awa.Aether_254.rtsbuilding.server.service.resolver.RtsLinkedHandlerResolutionService} 解析流体处理器</li>
 *   <li>使用 {@link awa.Aether_254.rtsbuilding.server.camera.RtsCameraManager} 检查相机状态</li>
 * </ul>
 */
