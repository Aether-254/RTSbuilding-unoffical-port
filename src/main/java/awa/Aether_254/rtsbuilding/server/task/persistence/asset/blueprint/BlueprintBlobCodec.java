...
import awa.Aether_254.rtsbuilding.server.task.persistence.NbtStringLimits;
...
public final class BlueprintBlobCodec {
    ...
    public BlueprintBlobRecord decode(CompoundTag root) {
        try {
            ...
            if (!awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.has(root, "asset_id") || !awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.has(root, "task_id")) {
            ...
            BlueprintBlobRecord record = new BlueprintBlobRecord(
                    new TaskAssetId(awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.get(root, "asset_id")),
                    new TaskId(awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.get(root, "task_id")),
    ...
    private static CompoundTag contentTag(BlueprintBlobRecord record) {
        ...
        awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.put(content, "asset_id", record.assetId().value());
        awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.put(content, "task_id", record.taskId().value());
    ...
    private static String hashContent(TaskAssetId assetId, TaskId taskId, int blockCount, String name,
            String sourceName, String format, CompoundTag structure) {
        CompoundTag content = new CompoundTag();
        awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.put(content, "asset_id", assetId.value());
        awa.Aether_254.rtsbuilding.common.nbt.RtsNbtUuid.put(content, "task_id", taskId.value());
