...
public final class BuiltInRtsPluginCatalog {
    ...
    public static final Identifier HARVEST_TIER_STONE = id("harvest_tier_stone");
    public static final Identifier HARVEST_TIER_IRON = id("harvest_tier_iron");
    public static final Identifier HARVEST_TIER_DIAMOND = id("harvest_tier_diamond");
    public static final Identifier HARVEST_TIER_UNLIMITED = id("harvest_tier_unlimited");
    ...
    private static RtsPluginDefinition harvestTierDefinition(Identifier pluginId,
