...
import awa.Aether_254.rtsbuilding.client.rendering.util.CornerBracketRenderer;
import awa.Aether_254.rtsbuilding.client.rendering.util.RaycastHelper;
...
public final class UltimineGhostRenderer {
    ...
    static void render(ShapeDataRecords.GhostPreview preview, PoseStack poseStack,
        ...
        if (mc != null && mc.level != null && mc.getCameraEntity() != null
                && mc.screen instanceof awa.Aether_254.rtsbuilding.client.screen.standalone.BuilderScreen) {
