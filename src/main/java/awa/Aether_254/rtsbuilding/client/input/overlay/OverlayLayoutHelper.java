...
import static awa.Aether_254.rtsbuilding.client.input.RtsClientInputGate.overlayCollapsed;
import static awa.Aether_254.rtsbuilding.client.input.RtsClientInputGate.overlayCraftCollapsed;
...
public final class OverlayLayoutHelper {
    ...
    public static String sortShort(awa.Aether_254.rtsbuilding.network.storage.RtsStorageSort sort) {
        return switch (sort) {
            case QUANTITY -> "Q";
            case MOD -> "M";
            case NAME -> "N";
