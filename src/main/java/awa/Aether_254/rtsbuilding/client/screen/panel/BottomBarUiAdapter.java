...
import awa.Aether_254.rtsbuilding.client.screen.standalone.RtsPluginManagementScreen;
...
import static awa.Aether_254.rtsbuilding.client.screen.standalone.BuilderScreenConstants.SLOT;
import static awa.Aether_254.rtsbuilding.client.screen.standalone.BuilderScreenConstants.STORAGE_RECENT_GAP;
...
final class BottomBarUiAdapter {
    ...
    private static List<BottomBarUiToolSlot> tools(BottomPanel panel) {
        ...
        int selectedHotbar = mc != null && mc.player != null ? mc.player.getInventory().getSelectedSlot() : -1;
        for (int i = 0; i < 9; i++) {
