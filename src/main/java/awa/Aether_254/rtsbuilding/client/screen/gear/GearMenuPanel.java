...
import awa.Aether_254.rtsbuilding.uicore.settings.SettingsUiSection;
...
public final class GearMenuPanel extends RtsWindowPanel {
    ...
    private void handleCoreClick(double mouseX, double mouseY) {
        ...
        for (SettingsWindowLayout.Node node : layout.nodes) {
            ...
            if (row.id.kind == awa.Aether_254.rtsbuilding.uicore.settings.SettingsRowKind.SENSITIVITY
            ...
            if (row.id.kind == awa.Aether_254.rtsbuilding.uicore.settings.SettingsRowKind.STEP_VALUE) {
            ...
            if ((row.id.kind == awa.Aether_254.rtsbuilding.uicore.settings.SettingsRowKind.SIMPLE_TOGGLE
                    || row.id.kind == awa.Aether_254.rtsbuilding.uicore.settings.SettingsRowKind.HINT_TOGGLE)
