 ...
 * <p>
 * History is now fully managed on the server (see {@link awa.Aether_254.rtsbuilding.server.history.ServerHistoryManager}).
...
public final class PlacementHistoryManager {
     ...
     * <p>
     * Called by {@link awa.Aether_254.rtsbuilding.client.network.RtsClientNetworkHandlers#handleHistorySync}
     * when a {@link awa.Aether_254.rtsbuilding.network.builder.S2CRtsHistorySyncPayload} is received.
     *
