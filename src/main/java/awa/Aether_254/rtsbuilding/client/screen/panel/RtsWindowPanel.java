...
import awa.Aether_254.rtsbuilding.common.persist.BoundsProvider;
import awa.Aether_254.rtsbuilding.common.persist.PersistableProperty;
import awa.Aether_254.rtsbuilding.uikit.theme.RtsMainlineTheme;
...
public abstract class RtsWindowPanel implements RtsPanel, BoundsProvider {
    ...
    public boolean handleClick(double mouseX, double mouseY, int button) {
        ...
        if (button == GLFW.GLFW_MOUSE_BUTTON_LEFT) {
            if (this.closable && this.closeButton != null && this.closeButton.mouseClicked(new net.minecraft.client.input.MouseButtonEvent(mouseX, mouseY, new net.minecraft.client.input.MouseButtonInfo(button, 0)), true)) {
                setOpen(false);
                return true;
            }
            if (this.resizable) {
