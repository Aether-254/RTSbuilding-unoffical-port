...
import awa.Aether_254.rtsbuilding.client.screen.panel.RtsWindowPanel;
...
import awa.Aether_254.rtsbuilding.client.widget.WindowButton;
import awa.Aether_254.rtsbuilding.client.widget.WindowSlider;
import awa.Aether_254.rtsbuilding.common.persist.PersistableProperty;
...
public final class QuickBuildPanel extends RtsWindowPanel {
    ...
    protected void renderContent(GuiGraphics g, int mouseX, int mouseY, float partialTick) {
        ...
        for (int i = 0; i < shapeButtons.length; i++) {
            ...
            if (core.mode == QuickBuildUiMode.DESTROY
                    && option.shape == awa.Aether_254.rtsbuilding.uicore.quickbuild.QuickBuildUiShape.CHAIN
                    && core.chainMode()) {
    ...
    protected void handleContentClick(double mouseX, double mouseY, int button) {
        ...
        for (WindowButton btn : shapeButtons) {
            if (btn.mouseClicked(new net.minecraft.client.input.MouseButtonEvent(mouseX, mouseY, new net.minecraft.client.input.MouseButtonInfo(button, 0)), true)) {
                return;
            }
        }
        ...
        if (this.connectToggle != null && this.connectToggle.mouseClicked(new net.minecraft.client.input.MouseButtonEvent(mouseX, mouseY, new net.minecraft.client.input.MouseButtonInfo(button, 0)), true)) {
            return;
        }
    }
