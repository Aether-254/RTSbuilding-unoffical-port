...
import static awa.Aether_254.rtsbuilding.client.screen.blueprint.BlueprintMaterialInspector.buildStats;
import static awa.Aether_254.rtsbuilding.client.screen.blueprint.BlueprintMaterialInspector.detailLines;
    ...
    private static void renderCoreRows(GuiGraphics g, Font font, List<BlueprintMaterialUiState.Row> lines,
        ...
        for (int row = 0; row < visible; row++) {
            for (int column = 0; column < columns; column++) {
                ...
                Identifier id = Identifier.tryParse(line.iconId);
