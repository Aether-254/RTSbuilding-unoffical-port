package awa.Aether_254.rtsbuilding.client.screen.storage;

import awa.Aether_254.rtsbuilding.client.controller.ClientRtsController;
import awa.Aether_254.rtsbuilding.client.record.LinkedStorageEntry;
...
import awa.Aether_254.rtsbuilding.network.storage.C2SRtsLinkStoragePayload;
...
public final class LinkedStoragePanel extends RtsWindowPanel {
    ...
    protected boolean handleWindowKeyPressed(int keyCode, int scanCode, int modifiers) {
        ...
        return this.priorityInput.keyPressed(new net.minecraft.client.input.KeyEvent(keyCode, scanCode, modifiers));
    }
    ...
    protected boolean handleWindowCharTyped(char codePoint, int modifiers) {
        return this.priorityInput != null
                ...
                && this.priorityInput.charTyped(new net.minecraft.client.input.CharacterEvent(codePoint, modifiers));
    }
