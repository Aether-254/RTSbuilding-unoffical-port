package awa.Aether_254.rtsbuilding.client.screen.guide;
...
import awa.Aether_254.rtsbuilding.client.screen.standalone.BuilderScreenConstants;
import awa.Aether_254.rtsbuilding.client.screen.topbar.TopBarIconRenderer;
import awa.Aether_254.rtsbuilding.client.screen.topbar.TopBarTypes;
import awa.Aether_254.rtsbuilding.client.screen.layout.JadeOverlayLayout;
...
import awa.Aether_254.rtsbuilding.uicore.guide.GuideUiIcon;
...
public final class GuidePanel extends RtsWindowPanel {
    ...
    private void drawGuideTextureIcon(GuiGraphics g, Identifier texture, int cx, int cy) {
        g.pose().pushMatrix();
