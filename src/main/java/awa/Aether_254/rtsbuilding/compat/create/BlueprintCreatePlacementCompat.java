package awa.Aether_254.rtsbuilding.compat.create;
...
public final class BlueprintCreatePlacementCompat {
    ...
    private static CompoundTag prepareWithCreate(
        ...
        try {
            virtual.loadWithComponents(net.minecraft.world.level.storage.TagValueInput.create(
                    net.minecraft.util.ProblemReporter.DISCARDING, level.registryAccess(), loadTag));
        ...
        synchronized (BlueprintCreatePlacementCompat.class) {
            ...
            try {
                ...
                Class<?> helper = Class.forName(
                        "com.zurrtum.create.foundation.utility.BlockHelper", false, loader);
