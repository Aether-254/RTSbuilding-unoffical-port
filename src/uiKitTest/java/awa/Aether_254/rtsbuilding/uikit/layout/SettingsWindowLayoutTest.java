package awa.Aether_254.rtsbuilding.uikit.layout;
...
class SettingsWindowLayoutTest {
    ...
    private static SettingsUiState state(EnumSet<SettingsSectionId> sections,
        ...
        for (SettingsId id : SettingsId.values()) {
            values.put(id, id.kind == awa.Aether_254.rtsbuilding.uicore.settings.SettingsRowKind.SENSITIVITY
                    || id.kind == awa.Aether_254.rtsbuilding.uicore.settings.SettingsRowKind.STEP_VALUE
